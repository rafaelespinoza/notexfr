	...
	t.Run("Read", func(t *testing.T) {
		...
		expectedResources := []*entity.Note{
			...
			},
			{
				...
				Tags:      nil,
				Title:     "Atlanta",
				UpdatedAt: time.Date(2020, 4, 19, 19, 51, 54, 0, time.UTC),
			},
			{
				Attributes: &entity.Attributes{},
			...
			},
			{
				...
				UpdatedAt: time.Date(2020, 4, 19, 19, 52, 14, 0, time.UTC),
			},
			{
				Attributes: &entity.Attributes{},
				...
				Tags:      nil,
				Title:     "Fargo",
				UpdatedAt: time.Date(2020, 4, 19, 19, 51, 4, 0, time.UTC),
			},
			{
				Attributes: &entity.Attributes{},
			...
			},
			{
				...
				Tags:      nil,
				Title:     "Fargo",
				UpdatedAt: time.Date(2020, 4, 19, 19, 51, 23, 0, time.UTC),
			},
			{
				Attributes: &entity.Attributes{
					Source: "desktop.mac",
